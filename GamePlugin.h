#pragma once
#include <CryECS/IECS.h>
#include <CrySystem/ICryPlugin.h>
#include <CryEntitySystem/IEntityClass.h>
#include <CryNetwork/INetwork.h>
#include "entt/Systems/PartitionSystem.h"



#include "CryECS/Registry.h"
...
public:
	...
	virtual void MainUpdate(float frameTime) final;
	// ~Cry::IEnginePlugin
	...
	entt::registry& GetRegistry() { return m_pRegistry->registry; }
protected:
	...
	std::unique_ptr<Systems::Partition::PartitionSystem> m_pPartitionSystem;

	Cry::ECS::TRegistryPtr m_pRegistry;

	Cry::ECS::PerModuleScope scope;
};